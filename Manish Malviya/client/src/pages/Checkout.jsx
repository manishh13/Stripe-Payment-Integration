...
const stripePromise = loadStripe("pk_test_51QZ8PkCy9dcLAcksXGcQ4C5HbH5qqwXO1llEAroCKBooMOf5mcf82q8JkIzt26IXOUI8HHLTE5jFcRFcD0KzuxNW00AZeeyyvL");
...
const CheckoutForm = ({ totalAmount, products }) => {
  ...
  return (
    <Form onSubmit={handleSubmit} style={{ width: "90%" }}>
      ...
      <Button style={{marginTop:"25px"}} variant="primary" type="submit" disabled={!stripe || isProcessing}>
